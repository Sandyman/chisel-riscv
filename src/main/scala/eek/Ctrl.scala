...
object PCMux {
    ...
    val PC_MUX_OFF_RS = 1.U(2.W)
    val PC_MUX_OFF    = 2.U(2.W)
    val PC_MUX_N      = 0.U(2.W)
}
    ...
    val ctrl_signals =
        ListLookup(io.inst,
            ...
            Array(
                ...
                JAL    -> List(Y, A_MUX_PC, B_MUX_IMM,  OP_ADD,  REG_WEN_1, MEM_WEN_0, MEM_REN_0, JImm, REG_MUX_PC_4,  PC_MUX_OFF,    BR_N),
                JALR   -> List(Y, A_MUX_PC, B_MUX_IMM,  OP_ADD,  REG_WEN_1, MEM_WEN_0, MEM_REN_0, IImm, REG_MUX_PC_4,  PC_MUX_OFF_RS, BR_N),
